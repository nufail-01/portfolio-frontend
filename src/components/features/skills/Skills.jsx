...
>
  ...
  <span className="sr-only"> — Developer Skills</span>
        ...
        {!loading && !error && (
          <>
            {/* Mobile: pill tab bar, one category visible at a time */}
            ...
            {/* Tablet/desktop: full grid, all categories visible */}
            <motion.div
              className="mt-16 hidden gap-8 md:grid md:grid-cols-2 lg:grid-cols-4"
